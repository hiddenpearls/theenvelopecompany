                    ...
                    <div class="span10">
                        ...
                        <div class="cart_search">
                            ...
                            <?php if (tesla_has_woocommerce()) { ?>
                                ...
                                <ul class="cart" style="line-height: 1.0em;" >     
                                                                      <span style="color:#fe3815; font-size:14px; line-height: 1.3em;">Call (800) 540-6883</span><br />
                            
                                    <li class="cart_bg" style="line-height: 1.5em;">
 
                                        <?php _e('My cart', 'hudson'); ?> ( <span class="dynamic_cart_contents_count">Total: </span><span class="dynamic_cart_total"><?php echo $woocommerce->cart->get_cart_subtotal(); ?></span> )
                            ...
                            <?php }
							$searchpages = htmlspecialchars($_GET["s"]);
							if(!empty($searchpages)) : ?>
								<style>
								.remove-for-search { display: none !important; visability: collapse !important; } 
								</style>
							<?php endif; ?>
                            <form action="<?php echo site_url('/'); ?>" class="search_form">
                                ...
                                <input type="hidden" name="post_type" value="product" class="search">
