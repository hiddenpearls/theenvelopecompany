...
return array(
    'error_class' => 'alert-error', //class added to container on error
    'required_class' => 'error', //class added to the required input with no value at submission
    ...
    'success_class' => 'alert-success', //class addded to container on successful subscription
    'animation_done_class' => 'animation_done',
    'result_timeout' => 15000, //time in ms to remove result container html and added classes (error_class or success_class)
    'result_container_selector' => '#tt_subscribe_form_result', //Jquery type selector for the result container
