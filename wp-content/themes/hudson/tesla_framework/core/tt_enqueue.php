        ...
        public static function load_stylesheet(){
            ...
            if (!empty(self::$base_gfonts)){
                ...
                foreach (self::$base_gfonts as $gfont){
                    if( strpos( $gfont, 'googleapis' ) )
                        wp_enqueue_style( 'tt-base-font' . rand(), $protocol . $gfont);
                    else
                        wp_enqueue_style( 'tt-base-font' . rand(), add_query_arg( 'family', urlencode( $gfont ), "//fonts.googleapis.com/css" ));
                }
            }
            ...
            if(!empty(self::$gfont_changer)){
                foreach(self::$gfont_changer as $font){
                    if( $font )
                        wp_enqueue_style( 'tt-custom-font-' . $font, add_query_arg( 'family', urlencode( $font ), "//fonts.googleapis.com/css" ));
                }
            }
