...
(function($){
    ...
    $(function(){
		...
		$('#slide_options').on('click','.tesla-option>button',function(){
			...
			/* FIX THE DANG RECURSIVE IN RECURSIVE BUG */
			t_clone.find('.tesla-option-template input, .tesla-option-template textarea, .tesla-option-template select[name]').prop('disabled',true);
			/* /END FIX THE DANG RECURSIVE IN RECURSIVE BUG */
		...
		$('#slide_options').on('change','select:not([name])',function(){
			...
			/* FIX THE DANG RECURSIVE IN RECURSIVE BUG */
			$('.tesla-option-template input, .tesla-option-template textarea, .tesla-option-template select[name]').prop('disabled',true);
			/* /END FIX THE DANG RECURSIVE IN RECURSIVE BUG */
