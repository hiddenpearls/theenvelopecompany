...
if ( function_exists( 'add_theme_support' ) ) { // Added in 2.9
  ...
  add_image_size('home-big-image',480,400,true);

  add_image_size('home-small-image',314,263,true);
...
function thistheme_widgets_init() {
	register_sidebar( array(
		'name' => __( 'Homepage Content One', 'imagethemeresponsive' ),
		'id' => 'sidebar-2',
		'description' => __( 'Appears on posts and pages except the optional Front Page template, which has its own widgets', 'imagethemeresponsive' ),
		'before_widget' => '<div class="homepage-content-top1">',
		'after_widget' => '</div></div>',
		'before_title' => '<div><h3 class="homepage-widget-title1">',
		'after_title' => '</h3>',
	) );

	register_sidebar( array(
		'name' => __( 'Homepage Content Two', 'imagethemeresponsive' ),
		'id' => 'sidebar-3',
		'description' => __( 'Appears on home page', 'imagethemeresponsive' ),
		'before_widget' => '<div class="homepage-content-top">',
		'after_widget' => '</div></div>',
		'before_title' => '<div><h3 class="homepage-widget-title">',
		'after_title' => '</h3>',
	) );

	register_sidebar( array(
		'name' => __( 'Footer One', 'imagethemeresponsive' ),
		'id' => 'sidebar-4',
		'description' => __( 'Footer Content', 'imagethemeresponsive' ),
	...
	register_sidebar( array(
		'name' => __( 'Footer Two', 'imagethemeresponsive' ),
		'id' => 'sidebar-5',
		'description' => __( 'Footer Content', 'imagethemeresponsive' ),
	...
	register_sidebar( array(
		'name' => __( 'Footer Three', 'imagethemeresponsive' ),
		'id' => 'sidebar-6',
		'description' => __( 'Footer Content', 'imagethemeresponsive' ),
		'before_widget' => '<div id="footer-box3">',
		'after_widget' => '</div>',
		'before_title' => '<h3 class="widget-title">',
		'after_title' => '</h3>',
	) );
	...
	register_sidebar( array(
		'name' => __( 'Footer Text', 'imagethemeresponsive' ),
		'id' => 'sidebar-7',
		'description' => __( 'Footer Bottom Text', 'imagethemeresponsive' ),
		'before_widget' => '<div>',
		'after_widget' => '</div>',
		'before_title' => '<h3 class="widget-title">',
		'after_title' => '</h3>',
	...
	register_sidebar( array(
		'name' => __( 'Copyright', 'imagethemeresponsive' ),
		'id' => 'sidebar-8',
		'description' => __( 'Copyright text', 'imagethemeresponsive' ),
		'before_widget' => '<div>',
		'after_widget' => '</div>',
		'before_title' => '<h3 class="widget-title">',
		'after_title' => '</h3>',
...
add_action( 'widgets_init', 'thistheme_widgets_init' );
...
class template1_search extends WP_Widget {
	...
	function template1_search() {
		...
		parent::WP_Widget(false, 'ImageTheme Search');
