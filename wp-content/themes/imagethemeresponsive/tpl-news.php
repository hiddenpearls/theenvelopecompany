...
<div class="page-wrapper">
	<div class="page-top"></div>
  	<div class="page-top-content">
        ...
        <?php } ?>            
          ...
          <div align="center"><a href="http://azenv.youareheremedia.com/online-quote/"><img src="http://azenv.youareheremedia.com/wp-content/themes/imagethemeresponsive/images/quotebtn.png" class="quotebtn" /></a></div>
	...
	<article>
		...
		<h1 class="single_title"><a href="<?php the_permalink(); ?>" title="Read more"><?php the_title(); ?></a></h1>
