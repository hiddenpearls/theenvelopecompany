...
function assets() {
  ...
  wp_enqueue_script('jqueryvalidate', Assets\asset_path('scripts/jquery.validate.js'), ['jquery'], null, true);
}
 ...
 */
add_action( 'after_setup_theme', 'Roots\Sage\Setup\woocommerce_support' );
