...
if(!class_exists('WCFD_Checkout_Fields_Export_Handler')):
 
class WCFD_Checkout_Fields_Export_Handler extends WCFD_Checkout_Fields_Utils {
	private $fields;
...
new WCFD_Checkout_Fields_Export_Handler();