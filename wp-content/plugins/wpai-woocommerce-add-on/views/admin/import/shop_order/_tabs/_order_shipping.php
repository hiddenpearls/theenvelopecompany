	...
	<div class="options_group hide_if_grouped">																						
		...
		<div style="margin-top:0; padding-left:8px;">
			<div class="form-field wpallimport-radio-field">
				...
				<label for="shipping_source_guest" style="width:auto;"><?php _e('Import shipping address', 'wp_all_import_plugin') ?></label>	
			</div>
		...
		<div class="input">
			<div class="form-field">
				<label><?php _e('Customer Provided Note', 'wp_all_import_plugin'); ?></label>
