...
class WooCommerce_Product_Search {
	...
	const USE_ADMIN_AJAX_DEFAULT    = false;
	...
	public static function init() {
		...
		//register_uninstall_hook( WOO_PS_FILE, array( __CLASS__, 'uninstall' ) );
	...
	public static function wp_init() {
		// translations
		load_plugin_textdomain( WOO_PS_PLUGIN_DOMAIN, null, 'woocommerce-product-search/languages' );
	}
	...
	public static function check_dependencies( $disable = false ) {
		...
		if ( !$woocommerce_is_active ) {
			self::$admin_messages[] = "<div class='error'>" . __( '<em>WooCommerce Product Search</em> is an extension for the <a href="http://www.woothemes.com/woocommerce/" target="_blank">WooCommerce</a> plugin. Please install and activate it.', WOO_PS_PLUGIN_DOMAIN ) . "</div>";
		}
