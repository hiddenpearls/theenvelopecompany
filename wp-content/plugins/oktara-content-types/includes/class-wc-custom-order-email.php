...
// need to create a class to extend the custom wc email
// add the different default values to the email
// validate the email should be send when the new order is placed
