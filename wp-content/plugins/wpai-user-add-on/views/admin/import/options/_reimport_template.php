	...
	<div class="wpallimport-content-section">
					...
					<table class="form-table" style="max-width:none;">
						<tr>
							<td>
								...
								<?php if ( ! $isWizard ):?>
								<h4><?php printf(__('WP All Import will associate records in your file with %s it has already created from previous runs of this import basis on the Unique Identifier.','wp_all_import_plugin'), $custom_type->labels->singular_name);?></h4>
								<?php endif; ?>
		...
		<?php else: ?>
			<?php if ( ! $isWizard ):?>
				<h3><?php _e('Record Matching', 'wp_all_import_plugin'); ?></h3>						
			<?php else: ?>
				<h3 style="padding-left:0;"><?php printf(__('WP All Import will merge data into existing %s.','wp_all_import_plugin'), $custom_type->labels->singular_name);?></h3>	
			<?php endif; ?>
			</div>
			<div class="wpallimport-collapsed-content" style="padding: 0;">
				<div class="wpallimport-collapsed-content-inner">
								...
								<div class="input" style="margin-bottom:15px; position:relative;">					
									...
									<div style="padding-left:17px;">
										<div class="input">																	
											...
											<label for="duplicate_indicator_title"><?php _e('match by Login', 'wp_all_import_plugin' )?></label><br>
											...
											<label for="duplicate_indicator_content"><?php _e('match by Email', 'wp_all_import_plugin' )?></label><br>
											<div class="input">
												...
												<label for="duplicate_indicator_custom_field"><?php _e('match by Custom Field', 'wp_all_import_plugin' )?></label><br>
