...
* Fixed PHP Warning about an invalid argument in foreach.
...
= 4.16.36 =
Added more firewall options, moved Scan Log from to the main Setings page, and fixed PHP Warning about an invalid argument.
