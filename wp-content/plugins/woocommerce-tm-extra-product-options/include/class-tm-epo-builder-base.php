...
final class TM_EPO_BUILDER_base {
	...
	private function init_elements(){
		...
		$this->elements_array=array(
			...
			"textarea"=>$this->add_element(
				"textarea",
				array("required","price","sale_price","text_before_price","text_after_price","price_type","hide_amount","quantity","placeholder","min_chars","max_chars","default_value_multiple","validation1")
				),			
			
			"textfield"=>$this->add_element(
				"textfield",
				array("required","price","sale_price","text_before_price","text_after_price","price_type2","freechars","hide_amount","quantity","placeholder","min_chars","max_chars","default_value","min","max","validation1")
				),
			...
			"upload"=>$this->add_element(
				"upload",
				array("required","price","sale_price","text_before_price","text_after_price","price_type5","hide_amount","button_type")
				),			
			
			"date"=>$this->add_element(
				"date",
				array("required","price","sale_price","text_before_price","text_after_price","price_type6","hide_amount","quantity","button_type2","date_format","start_year","end_year",
					array(
						"id" 				=> "date_min_date",
						"wpmldisable"=>1,
						"default"			=> "",
			...
			"time"=>$this->add_element(
				"time",
				array("required","price","sale_price","text_before_price","text_after_price","price_type6","hide_amount","quantity","time_format",
					array(
						"id" 				=> "time_min_time",
						"wpmldisable"=>1,
						"default"			=> "",
					...
					/*array(
						...
						"default"			=> "",
						"type"				=> "select",
						"tags"				=> array( "id"=>"builder_time_showhour", "name"=>"tm_meta[tmfbuilder][time_showhour][]" ),
						"options"			=> array(
							array( "text"=> __( "Yes", 'woocommerce-tm-extra-product-options' ), "value"=>"" ),
							array( "text"=> __( "No", 'woocommerce-tm-extra-product-options' ), "value"=>"no" ),
						),
						"label"		=> __( "Show hour", 'woocommerce-tm-extra-product-options' ),
						"desc" 		=> ""
					),
					array(
						"id" 				=> "time_showminute",
						...
						"default"			=> "",
						"type"				=> "select",
						"tags"				=> array( "id"=>"builder_time_showminute", "name"=>"tm_meta[tmfbuilder][time_showminute][]" ),
						"options"			=> array(
							array( "text"=> __( "Yes", 'woocommerce-tm-extra-product-options' ), "value"=>"" ),
							array( "text"=> __( "No", 'woocommerce-tm-extra-product-options' ), "value"=>"no" ),
						),
						"label"		=> __( "Show minute", 'woocommerce-tm-extra-product-options' ),
						"desc" 		=> ""
					),
					array(
						"id" 				=> "time_showsecond",
						...
						"default"			=> "",
						"type"				=> "select",
						"tags"				=> array( "id"=>"builder_time_showsecond", "name"=>"tm_meta[tmfbuilder][time_showsecond][]" ),
						"options"			=> array(
							array( "text"=> __( "Yes", 'woocommerce-tm-extra-product-options' ), "value"=>"" ),
							array( "text"=> __( "No", 'woocommerce-tm-extra-product-options' ), "value"=>"no" ),
						),
						"label"		=> __( "Show second", 'woocommerce-tm-extra-product-options' ),
						"desc" 		=> ""
					),*/
					array(
						"id" 				=> "time_theme",
			...
			"range"=>$this->add_element(
				"range",
				array("required","price","sale_price","text_before_price","text_after_price","price_type7","hide_amount","quantity","min","max","rangestep","show_picker_value","pips","noofpips","default_value")
				),

			"color"=>$this->add_element(
				"color",
				array("required","price","sale_price","text_before_price","text_after_price","price_type6","hide_amount","quantity","default_value")
				),
		...
		if ($this->woo_subscriptions_check){			
			$this->elements_array["textarea"][24]['options'][]=array( "text"=> __( "Subscription fee", 'woocommerce-tm-extra-product-options' ), "value"=>"subscriptionfee" );
			$this->elements_array["textfield"][24]['options'][]=array( "text"=> __( "Subscription fee", 'woocommerce-tm-extra-product-options' ), "value"=>"subscriptionfee" );
			$this->elements_array["date"][24]['options'][]=array( "text"=> __( "Subscription fee", 'woocommerce-tm-extra-product-options' ), "value"=>"subscriptionfee" );
			$this->elements_array["time"][24]['options'][]=array( "text"=> __( "Subscription fee", 'woocommerce-tm-extra-product-options' ), "value"=>"subscriptionfee" );
		}
	...
	public final function add_setting_price_type3($name=""){
		return array(
					...
					"options"	=> array(
						...
						array( "text"=> __( 'Fee', 'woocommerce-tm-extra-product-options' ), "value"=>"fee" ),
						array( "text"=> __( 'Subscription fee', 'woocommerce-tm-extra-product-options' ), "value"=>"subscriptionfee" ),
					),
					"label"		=> __( 'Price type', 'woocommerce-tm-extra-product-options' )
				);
	}
	...
	public final function add_setting_use_images($name=""){
		return array(
					...
					"desc" 		=> __( 'Choose whether to use images in place of radio buttons.', 'woocommerce-tm-extra-product-options' )
				);
	}
	...
	public final function add_element($name="",$settings=array(), $is_addon=false,$tabs_override=array()){
		$tabs_override = apply_filters('tc_tabs_override',$tabs_override,$name,$settings,$is_addon);
		$options = array();
		...
		return array_merge( 
				...
				!empty($tabs_override["general_options"])?$options:array(),
				...
				!empty($tabs_override["css_settings"])?array(
					array(
						"id" 		=> $name."_class",
						"default"	=> "",
						"type"		=> "text",
				...
				!empty($tabs_override["woocommerce_settings"])?array(
					array(
					...
					array(
						...
						"default"			=> "",
						"type"				=> "text",
						"tags"				=> array( "class"=>"t", "id"=>"builder_".$name."_tax_class_for_fee_price_type", "name"=>"tm_meta[tmfbuilder][".$name."_tax_class_for_fee_price_type][]", "value"=>"" ),
						"label"				=> __( 'Tax class for Fee price type', 'woocommerce-tm-extra-product-options' ),
						"desc" 				=> __( 'Leave this empty to inherit the product tax class.', 'woocommerce-tm-extra-product-options' )
					),
					array(
	...
	public function print_elements( $echo=0, $wpml_is_original_product=true ) {
		...
		$out  ='<div class="builder_elements closed"><div class="tc-handle tmicon tcfa tcfa-caret-up"></div><div class="builder_hidden_elements" data-template="'.esc_html( json_encode( array( "html"=>$out1 ) ) ).'"></div>'
				...
				.(($wpml_is_original_product)?'<div class="builder_actions">'.'<a class="builder_add_section tm-button bsbb" href="#"><i class="tcfa tcfa-plus-square"></i> '.__("Add section",'woocommerce-tm-extra-product-options').'</a>'.'</div>':'')
				."</div>";
		if ( empty( $echo ) ) {
			return $out;
		}else {
	...
	private function _section_template($out="",$size="",$section_size="", $sections_slides="", $elements="", $wpml_is_original_product=true,$sections_internal_name=false){
		...
		$adder_prepend='<div class="bitem-add tc-prepend tma-nomove"><div class="tm-add-element-action"><a title="'.__("Add element",'woocommerce-tm-extra-product-options').'" class="builder_add_element tc-prepend tmfa tcfa tcfa-plus"></a></div></div>';
		$adder_append='<div class="bitem-add tc-append tma-nomove"><div class="tm-add-element-action"><a title="'.__("Add element",'woocommerce-tm-extra-product-options').'" class="builder_add_element tc-append tmfa tcfa tcfa-plus"></a></div></div>';
		...
		$t1= "<div class='section_elements closed'>"
			...
			//. (($wpml_is_original_product)?"<div class='tmicon builder_add_on_section'>".__("Add item",'woocommerce-tm-extra-product-options')." <i class='tcfa tcfa-plus plus'></i></div>":"")
	...
	private function builder_sub_options( $options=array(), $name="multiple_selectbox_options", $counter=NULL , $default_value=NULL) {
		...
		if ($this->woo_subscriptions_check && $name!="multiple_selectbox_options"){
			$o["price_type"]['options'][]=array( "text"=> __( "Subscription fee", 'woocommerce-tm-extra-product-options' ), "value"=>"subscriptionfee" );
		}
		if ($name!="multiple_selectbox_options"){
		...
		$drag=TM_EPO_HTML()->tm_make_button( array(
				...
				"tags"=>array( "href"=>"#move", "class"=>"button button-secondary button-small builder_panel_move" )
				), 0 ).
			TM_EPO_HTML()->tm_make_button( array(
				"text"=>"<i class='tcfa tcfa-angle-up'></i>",
				"tags"=>array( "href"=>"#move", "class"=>"button button-secondary button-small builder_panel_up" )
				), 0 ).
			TM_EPO_HTML()->tm_make_button( array(
				"text"=>"<i class='tcfa tcfa-angle-down'></i>",
				"tags"=>array( "href"=>"#move", "class"=>"button button-secondary button-small builder_panel_down" )
				), 0 )
		;
		...
		$out  = "<div class='tm-row nopadding multiple_options tc-clearfix'>"
			...
			. "<div class='tm-cell col-2 tm_cell_images'>".__( "Images", 'woocommerce-tm-extra-product-options' )."</div>"
			...
			. "<div class='tm-cell col-auto tm_cell_delete'><span class='tm-button button button-primary button-large builder_panel_delete_all'>".__( "Delete all options", 'woocommerce-tm-extra-product-options' )."</span></div>"
			. "</div>";
		...
		foreach ( $options["title"] as $ar=>$el ) {
			...
			$out .= "<div class='tm-cell col-2 tm_cell_images'>".TM_EPO_HTML()->tm_make_field( $o["image"], 0 ).TM_EPO_HTML()->tm_make_field( $o["imagep"], 0 ).TM_EPO_HTML()->tm_make_field( $o["imagel"], 0 )."</div>";
		...
		$out .="</div>";
		$out .=' <a class="tm-button button button-primary button-large builder-panel-add" href="#">'.__( "Add item", 'woocommerce-tm-extra-product-options' ).'</a>';
		$out .=' <a class="tm-button button button-primary button-large builder-panel-mass-add" href="#">'.__( "Mass add", 'woocommerce-tm-extra-product-options' ).'</a>';
