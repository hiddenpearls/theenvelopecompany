...
class TM_EPO_FIELDS {
	...
	public function fill_currencies() {
		...
		foreach ($price_per_currencies as $currency => $price_rule) {
			...
			$currency_price=TM_EPO()->calculate_price( $this->post_data, $copy_element, $this->key, $this->attribute, $this->per_product_pricing, $this->cpf_product_price, $this->variation_id, '' , $currency, $current_currency);
