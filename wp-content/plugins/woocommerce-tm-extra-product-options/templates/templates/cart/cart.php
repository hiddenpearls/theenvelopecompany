					...
					<td class="product-price">
						<?php
							if (TM_EPO()->tm_epo_hide_options_in_cart=="normal"){
								echo apply_filters( 'wc_tm_epo_ac_product_price', apply_filters( 'woocommerce_cart_item_price', WC()->cart->get_product_price( $original_product ), $cart_item, $cart_item_key ) , $cart_item_key, $cart_item, $original_product, $product_id );
							}else{
