...
<div id="tm_extra_product_options" class="panel wc-metaboxes-wrapper">
    ...
    <div id="tm_extra_product_options_inner">
        <div class="tm_mode_selector">
            ...
            <p class="form-field tm_mode_select title"><?php _e( 'Select mode', 'woocommerce-tm-extra-product-options' ); ?></p>
            <p class="form-field tm_mode_select">
                <span class="button button-primary button-large tm_select_mode tm_builder_select"><?php _e( 'BUILDER', 'woocommerce-tm-extra-product-options' ); ?></span>
                <span class="button button-primary button-large tm_select_mode tm_local_select"><?php _e( 'LOCAL', 'woocommerce-tm-extra-product-options' ); ?></span>
                <span class="button button-primary button-large tm_select_mode tm_settings_select"><?php _e( 'SETTINGS', 'woocommerce-tm-extra-product-options' ); ?></span>
            </p> 
        </div>
