...
<?php else : ?>
        <p class="toolbar">
            <a href="#" class="close_all tm-button tc-clearfix"><?php _e( 'Close all', 'woocommerce-tm-extra-product-options' ); ?></a><a href="#" class="expand_all tm-button tc-clearfix"><?php _e( 'Expand all', 'woocommerce-tm-extra-product-options' ); ?></a>
        </p>
...
?>
        ...
        <p class="toolbar">
            <button type="button" class="tm-button fr button button-primary tm_add_epo" <?php disabled( ( count($attributes)>0 ), false ); ?>><?php _e( 'Add Extra Option', 'woocommerce-tm-extra-product-options' ); ?></button>
            <span class="fr">
<?php
