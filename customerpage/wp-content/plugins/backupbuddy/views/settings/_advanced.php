...
/* Bad Mojo - commented out ^ gta
$settings_form->add_setting( array(
	'type'		=>		'checkbox',
	'name'		=>		'alternative_zip_1',
	'options'	=>		array( 'unchecked' => '0', 'checked' => '1' ),
	'title'		=>		'<b>' . __( 'Legacy zip system (old)', 'it-l10n-backupbuddy' ) . '</b>',
	'tip'		=>		__( '[Default: Disabled] Use if needing Windows zip.exe support.', 'it-l10n-backupbuddy' ),
	'css'		=>		'',
