...
if ( ( 'add' == $mode ) || ( 'edit' == $mode ) ) {
	echo '<br>';
	pb_backupbuddy::alert( 'Attention: This remote destination deprecated. For the best experience please use the newer Amazon S3 (v2) destination. If you do not see it verify your server is running PHP v5.3 or newer.' );
	echo '<br><br>';
}
